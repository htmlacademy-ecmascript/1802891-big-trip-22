...
/* harmony export */   NoTasksTextType: () => (/* binding */ NoTasksTextType),
...
/* harmony export */ });
/* harmony import */ var _framework_observable__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../framework/observable */ "./src/framework/observable.js");
/* harmony import */ var _const__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../const */ "./src/const.js");


class FilterModel extends _framework_observable__WEBPACK_IMPORTED_MODULE_0__["default"] {
  #filter = _const__WEBPACK_IMPORTED_MODULE_1__.FilterType.EVERYTHING;
  get filter() {
    return this.#filter;
  }
...
/* harmony import */ var _framework_observable_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../framework/observable.js */ "./src/framework/observable.js");
/* harmony import */ var _view_ErrorServerView_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../view/ErrorServerView.js */ "./src/view/ErrorServerView.js");




class PointModel extends _framework_observable_js__WEBPACK_IMPORTED_MODULE_2__["default"] {
  #points = [];
  #offers = [];
  #destinations = [];
  ...
  async init() {
    try {
      ...
      this.#errorServerView = new _view_ErrorServerView_js__WEBPACK_IMPORTED_MODULE_3__["default"]();
      (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_1__.render)(this.#errorServerView, this.#contentContainer);
    }
    this._notify(_const_js__WEBPACK_IMPORTED_MODULE_0__.UpdateType.INIT);
  }
  get points() {
    return this.#points;
  }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ PointApiService)
/* harmony export */ });
/* harmony import */ var _framework_api_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./framework/api-service */ "./src/framework/api-service.js");
...
class PointApiService extends _framework_api_service__WEBPACK_IMPORTED_MODULE_0__["default"] {
  get points() {
    return this._load({
      url: 'points'
    }).then(_framework_api_service__WEBPACK_IMPORTED_MODULE_0__["default"].parseResponse);
  }
  get destinations() {
    return this._load({
      url: 'destinations'
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ ContentPresenter)
/* harmony export */ });
/* harmony import */ var _view_ListPointView_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../view/ListPointView.js */ "./src/view/ListPointView.js");
/* harmony import */ var _view_TripSortPointsView_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../view/TripSortPointsView.js */ "./src/view/TripSortPointsView.js");
/* harmony import */ var _framework_ui_blocker_ui_blocker_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../framework/ui-blocker/ui-blocker.js */ "./src/framework/ui-blocker/ui-blocker.js");
/* harmony import */ var _view_NoPointView_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../view/NoPointView.js */ "./src/view/NoPointView.js");
...
/* harmony import */ var _header_presenter_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./header-presenter.js */ "./src/presenter/header-presenter.js");
/* harmony import */ var _utils_filter_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../utils/filter.js */ "./src/utils/filter.js");
/* harmony import */ var _view_LoadingView_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../view/LoadingView.js */ "./src/view/LoadingView.js");
...
class ContentPresenter {
  #tripList = new _view_ListPointView_js__WEBPACK_IMPORTED_MODULE_0__["default"]();
  #loadingComponent = new _view_LoadingView_js__WEBPACK_IMPORTED_MODULE_10__["default"]();
  ...
  #pointModel = null;
  #filterModel = null;
  #currentTypeSort = _const_js__WEBPACK_IMPORTED_MODULE_6__.SortType.DAY;
  #filterType = _const_js__WEBPACK_IMPORTED_MODULE_6__.FilterType.EVERYTHING;
  #isLoading = true;
  #uiBlocker = new _framework_ui_blocker_ui_blocker_js__WEBPACK_IMPORTED_MODULE_2__["default"]({
  ...
  get points() {
    ...
    const filteredPoints = _utils_filter_js__WEBPACK_IMPORTED_MODULE_9__.filter[this.#filterType](point);
    switch (this.#currentTypeSort) {
      case _const_js__WEBPACK_IMPORTED_MODULE_6__.SortType.TIME:
        return filteredPoints.sort(_utils_point_js__WEBPACK_IMPORTED_MODULE_5__.sortPointByTime);
      case _const_js__WEBPACK_IMPORTED_MODULE_6__.SortType.PRICE:
        return filteredPoints.sort(_utils_point_js__WEBPACK_IMPORTED_MODULE_5__.sortPointByPrice);
      case _const_js__WEBPACK_IMPORTED_MODULE_6__.SortType.DAY:
        return filteredPoints.sort(_utils_point_js__WEBPACK_IMPORTED_MODULE_5__.sortPointsByDay);
    }
  ...
  #renderNoPoint() {
    this.#noPointComponent = new _view_NoPointView_js__WEBPACK_IMPORTED_MODULE_3__["default"]({
      isErrorServer: false,
      filterType: this.#filterType
    });
    (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_7__.render)(this.#noPointComponent, this.#contentContainer);
  }
  #renderLoading() {
    (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_7__.render)(this.#loadingComponent, this.#contentContainer, _framework_render_js__WEBPACK_IMPORTED_MODULE_7__.RenderPosition.AFTERBEGIN);
  }
  #renderContents(resetSortType = false) {
    this.#pointPresenter = new _point_presenter_js__WEBPACK_IMPORTED_MODULE_4__["default"](this.#tripList.element, this.#pointModel, this.#handleViewAction, this.#handlerModeChange);
    if (this.#isLoading && !this.#pointModel.isErrorServer) {
      this.#renderLoading();
      return;
    }
    if (resetSortType) {
      this.#currentTypeSort = _const_js__WEBPACK_IMPORTED_MODULE_6__.SortType.DAY;
    }
    ...
    (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_7__.render)(this.#tripList, this.#contentContainer);
    this.#renderPoints(this.points);
  }
  #renderHeader() {
    this.#headerPresenter = new _header_presenter_js__WEBPACK_IMPORTED_MODULE_8__["default"]({
  ...
  #renderSortPointsComponent() {
    this.#sortPointView = new _view_TripSortPointsView_js__WEBPACK_IMPORTED_MODULE_1__["default"](this.#handlerSortTypePoints, this.#currentTypeSort);
    (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_7__.render)(this.#sortPointView, this.#contentContainer, _framework_render_js__WEBPACK_IMPORTED_MODULE_7__.RenderPosition.AFTERBEGIN);
  }
  #handleViewAction = async (actionType, updateType, update) => {
    this.#uiBlocker.block();
    switch (actionType) {
      case _const_js__WEBPACK_IMPORTED_MODULE_6__.UserAction.UPDATE_POINT:
        ...
        break;
      case _const_js__WEBPACK_IMPORTED_MODULE_6__.UserAction.ADD_POINT:
        ...
        break;
      case _const_js__WEBPACK_IMPORTED_MODULE_6__.UserAction.DELETE_POINT:
  ...
  #handleModelEvent = (updateType, data) => {
    switch (updateType) {
      ...
      case _const_js__WEBPACK_IMPORTED_MODULE_6__.UpdateType.INIT:
        ...
        (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_7__.remove)(this.#loadingComponent);
        this.#renderContents();
        break;
    }
  };
  #clearContent({
    ...
    (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_7__.remove)(this.#loadingComponent);
    (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_7__.remove)(this.#sortPointView);
    (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_7__.remove)(this.#noPointComponent);
    if (resetSortType) {
      this.#currentTypeSort = _const_js__WEBPACK_IMPORTED_MODULE_6__.SortType.DAY;
    }
  }
  ...
  #handlerOpenAddPoint = () => {
    ...
    this.#currentTypeSort = _const_js__WEBPACK_IMPORTED_MODULE_6__.SortType.DAY;
    this.#filterType = _const_js__WEBPACK_IMPORTED_MODULE_6__.FilterType.EVERYTHING;
    (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_7__.remove)(this.#sortPointView);
    this.#renderSortPointsComponent();
...
/* harmony export */ });
/* harmony import */ var _view_TripFilterControlsView_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../view/TripFilterControlsView.js */ "./src/view/TripFilterControlsView.js");
/* harmony import */ var _view_InfoTextHeaderView_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../view/InfoTextHeaderView.js */ "./src/view/InfoTextHeaderView.js");
/* harmony import */ var _view_InfoTitleHeaderView_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../view/InfoTitleHeaderView.js */ "./src/view/InfoTitleHeaderView.js");
/* harmony import */ var _view_InfoPriceHeaderView_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../view/InfoPriceHeaderView.js */ "./src/view/InfoPriceHeaderView.js");
/* harmony import */ var _view_InfoContainerView_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../view/InfoContainerView.js */ "./src/view/InfoContainerView.js");
/* harmony import */ var _view_InfoWrapperContentView_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../view/InfoWrapperContentView.js */ "./src/view/InfoWrapperContentView.js");
/* harmony import */ var _view_ButtonAddNewPointView_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../view/ButtonAddNewPointView.js */ "./src/view/ButtonAddNewPointView.js");
...
class HeaderPresenter {
  #tripContainer = new _view_InfoContainerView_js__WEBPACK_IMPORTED_MODULE_4__["default"]();
  #tripWrapperContent = new _view_InfoWrapperContentView_js__WEBPACK_IMPORTED_MODULE_5__["default"]();
  #infoPriceView = null;
  #infoTitleView = null;
  #infoDataView = null;
  ...
  get filters() {
    return Object.values(_const_js__WEBPACK_IMPORTED_MODULE_7__.FilterType).map(type => type);
  }
  init() {
    this.#headerContainer = document.querySelector('.trip-main');
    this.#containerFilters = document.querySelector('.trip-controls__filters');
    this.#infoDataView = new _view_InfoTextHeaderView_js__WEBPACK_IMPORTED_MODULE_1__["default"](this.#pointModel);
    this.#infoPriceView = new _view_InfoPriceHeaderView_js__WEBPACK_IMPORTED_MODULE_3__["default"](this.#pointModel);
    this.#infoTitleView = new _view_InfoTitleHeaderView_js__WEBPACK_IMPORTED_MODULE_2__["default"](this.#pointModel);
    (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_9__.render)(this.#tripContainer, this.#headerContainer, _framework_render_js__WEBPACK_IMPORTED_MODULE_9__.RenderPosition.AFTERBEGIN);
    (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_9__.render)(this.#infoPriceView, this.#tripContainer.element);
    (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_9__.render)(this.#tripWrapperContent, this.#tripContainer.element, _framework_render_js__WEBPACK_IMPORTED_MODULE_9__.RenderPosition.AFTERBEGIN);
    (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_9__.render)(this.#infoTitleView, this.#tripWrapperContent.element);
    (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_9__.render)(this.#infoDataView, this.#tripWrapperContent.element);
    (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_9__.render)(new _view_ButtonAddNewPointView_js__WEBPACK_IMPORTED_MODULE_6__["default"](this.#handlerOpenPointClick, this.#pointModel.isErrorServer), this.#headerContainer);
  }
  initFilters() {
    ...
    this.#pointsTimesLength = Object.create({}, {
      [_const_js__WEBPACK_IMPORTED_MODULE_7__.FilterType.EVERYTHING]: {
        value: _utils_filter_js__WEBPACK_IMPORTED_MODULE_8__.filter[_const_js__WEBPACK_IMPORTED_MODULE_7__.FilterType.EVERYTHING](points).length
      },
      [_const_js__WEBPACK_IMPORTED_MODULE_7__.FilterType.FUTURE]: {
        value: _utils_filter_js__WEBPACK_IMPORTED_MODULE_8__.filter[_const_js__WEBPACK_IMPORTED_MODULE_7__.FilterType.FUTURE](points).length
      },
      [_const_js__WEBPACK_IMPORTED_MODULE_7__.FilterType.PRESENT]: {
        value: _utils_filter_js__WEBPACK_IMPORTED_MODULE_8__.filter[_const_js__WEBPACK_IMPORTED_MODULE_7__.FilterType.PRESENT](points).length
      },
      [_const_js__WEBPACK_IMPORTED_MODULE_7__.FilterType.PAST]: {
        value: _utils_filter_js__WEBPACK_IMPORTED_MODULE_8__.filter[_const_js__WEBPACK_IMPORTED_MODULE_7__.FilterType.PAST](points).length
      }
    });
    this.#filterComponent = new _view_TripFilterControlsView_js__WEBPACK_IMPORTED_MODULE_0__["default"]({
      filters,
    ...
    if (prevFilterComponent === null) {
      (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_9__.render)(this.#filterComponent, this.#containerFilters);
      return;
    }
    (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_9__.replace)(this.#filterComponent, prevFilterComponent);
    (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_9__.remove)(prevFilterComponent);
  }
  #handelModeEvent = () => {
    this.initFilters();
  };
  #handlerFilterTypeChange = filterType => {
    ...
    this.#filtersModel.setFilter(_const_js__WEBPACK_IMPORTED_MODULE_7__.UpdateType.MAJOR, filterType);
  };
  removeFilters() {
    (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_9__.remove)(this.#filterComponent);
    this.#filterComponent = null;
    this.#filtersModel.filter = _const_js__WEBPACK_IMPORTED_MODULE_7__.FilterType.EVERYTHING;
  }
  removeInfoComponents() {
    (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_9__.remove)(this.#infoDataView);
    (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_9__.remove)(this.#infoTitleView);
    (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_9__.remove)(this.#infoPriceView);
  }
...
/* harmony export */ });
/* harmony import */ var _view_EditPointView_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../view/EditPointView.js */ "./src/view/EditPointView.js");
/* harmony import */ var _view_PointView_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../view/PointView.js */ "./src/view/PointView.js");
/* harmony import */ var _view_NewPointView_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../view/NewPointView.js */ "./src/view/NewPointView.js");
...
class RenderPoint {
  ...
  init(point) {
    ...
    this.#pointView = new _view_PointView_js__WEBPACK_IMPORTED_MODULE_1__["default"]({
      point: point,
    ...
    this.#pointEditView = new _view_EditPointView_js__WEBPACK_IMPORTED_MODULE_0__["default"]({
      point: point,
      checkedOffers: [...this.#pointModel.getOfferById(point.typePoint, point.offers)],
    ...
    if (this.#mode === Mode.DEFAULT) {
      (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_5__.replace)(this.#pointView, prevPointView);
    }
  ...
  #handlerSwapEditToPointClick() {
    (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_5__.replace)(this.#pointEditView, this.#pointView);
    this.#handlerModeChange();
  ...
  #handlerSwapPointToEditClick() {
    ...
    (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_5__.replace)(this.#pointView, this.#pointEditView);
    this.#mode = Mode.DEFAULT;
  ...
  #handlerFormDeleteEditSubmit = point => {
    this.#handlerChangeData(_const_js__WEBPACK_IMPORTED_MODULE_3__.UserAction.DELETE_POINT, _const_js__WEBPACK_IMPORTED_MODULE_3__.UpdateType.MINOR, point);
  };
  #handlerCloseEdit = () => {
    this.#handlerSwapPointToEditClick();
    document.removeEventListener('keydown', this.#escKeyDownHandler);
  ...
  destroy() {
    (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_5__.remove)(this.#pointView);
    (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_5__.remove)(this.#pointEditView);
    (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_5__.remove)(this.#addPointView);
  }
  renderPointAdd = () => {
    if (this.#addPointView === null) {
      this.#addPointView = new _view_NewPointView_js__WEBPACK_IMPORTED_MODULE_2__["default"]({
        offers: [...this.#pointModel.offers],
        destinations: this.#pointModel.destinations,
...
/* harmony export */   isDateFuture: () => (/* binding */ isDateFuture),
/* harmony export */   isDatePast: () => (/* binding */ isDatePast),
/* harmony export */   isDatePresent: () => (/* binding */ isDatePresent),
...
function humanizeOrderData(date, format = _const_js__WEBPACK_IMPORTED_MODULE_2__.FormatTime.MONTH_DATA_FORMA) {
  return date ? dayjs__WEBPACK_IMPORTED_MODULE_0___default().utc(date).format(format) : '';
}
/**
...
function dateSubtract(dateEnd, dateStart) {
  const day = humanizeOrderData(dayjs__WEBPACK_IMPORTED_MODULE_0___default()(dateEnd).diff(dayjs__WEBPACK_IMPORTED_MODULE_0___default()(dateStart), 'day'), 'DD');
  const hour = humanizeOrderData(dayjs__WEBPACK_IMPORTED_MODULE_0___default()(dateEnd).diff(dayjs__WEBPACK_IMPORTED_MODULE_0___default()(dateStart)), _const_js__WEBPACK_IMPORTED_MODULE_2__.FormatTime.TIME_FORMAT_H);
  const minute = humanizeOrderData(dayjs__WEBPACK_IMPORTED_MODULE_0___default()(dateEnd).diff(dayjs__WEBPACK_IMPORTED_MODULE_0___default()(dateStart)), _const_js__WEBPACK_IMPORTED_MODULE_2__.FormatTime.TIME_FORMAT_M);
  const totalData = `${day !== '' ? `${day}D` : ''}
  ${day !== '' || hour !== '00' ? `${hour}H` : ''}
  ${day > 0 || hour > 0 || minute !== '00' ? `${minute}M` : ''}`;
  return totalData;
}
const isDateFuture = start => dayjs__WEBPACK_IMPORTED_MODULE_0___default()().isBefore(start);
const isDatePresent = (start, end) => dayjs__WEBPACK_IMPORTED_MODULE_0___default()().isAfter(start) && dayjs__WEBPACK_IMPORTED_MODULE_0___default()().isBefore(end);
const isDatePast = end => dayjs__WEBPACK_IMPORTED_MODULE_0___default()().isAfter(end);
function isDatesEqual(dateA, dateB) {
  return dateA === null && dateB === null || dayjs__WEBPACK_IMPORTED_MODULE_0___default()(dateA).isSame(dateB, _const_js__WEBPACK_IMPORTED_MODULE_2__.FormatTime.YEAR_MONTH_DAY);
}
...
const filter = {
  ...
  [_const__WEBPACK_IMPORTED_MODULE_0__.FilterType.FUTURE]: points => points.filter(point => (0,_date__WEBPACK_IMPORTED_MODULE_1__.isDateFuture)(point.startDate)),
  [_const__WEBPACK_IMPORTED_MODULE_0__.FilterType.PRESENT]: points => points.filter(point => (0,_date__WEBPACK_IMPORTED_MODULE_1__.isDatePresent)(point.startDate, point.endDate)),
  [_const__WEBPACK_IMPORTED_MODULE_0__.FilterType.PAST]: points => points.filter(point => (0,_date__WEBPACK_IMPORTED_MODULE_1__.isDatePast)(point.endDate))
};
...
function getDateDuration(day) {
  return dayjs__WEBPACK_IMPORTED_MODULE_0___default()(day.startDate).diff(dayjs__WEBPACK_IMPORTED_MODULE_0___default()(day.endDate));
}
...
function sortPointsByDay(pointA, pointB) {
  return dayjs__WEBPACK_IMPORTED_MODULE_0___default()(pointA.startDate) - dayjs__WEBPACK_IMPORTED_MODULE_0___default()(pointB.startDate);
}


/***/ }),

/***/ "./src/view/ButtonAddNewPointView.js":
/*!*******************************************!*\
  !*** ./src/view/ButtonAddNewPointView.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ ButtonAddPointView)
/* harmony export */ });
...
function createPicturesDestinationsTemplate(picture) {
  return `<img class="event__photo" src="${picture.src}" alt="${he__WEBPACK_IMPORTED_MODULE_4___default().encode(picture.description)}">`;
}
...
function createPointEditComponent({
  ...
  const startFormatDate = (0,_utils_date_js__WEBPACK_IMPORTED_MODULE_0__.humanizeOrderData)(startDate, _const_js__WEBPACK_IMPORTED_MODULE_2__.FormatTime.YEAR_MONTH_DAY_TIME);
  ...
  const endFormatDate = (0,_utils_date_js__WEBPACK_IMPORTED_MODULE_0__.humanizeOrderData)(endDate, _const_js__WEBPACK_IMPORTED_MODULE_2__.FormatTime.YEAR_MONTH_DAY_TIME);
  return `
...
class EventEditView extends _framework_view_abstract_stateful_view_js__WEBPACK_IMPORTED_MODULE_1__["default"] {
  ...
  #setStartDatePicker() {
    this.#datePicker = (0,flatpickr__WEBPACK_IMPORTED_MODULE_3__["default"])(this.element.querySelector('#event-start-time-1'), {
      ...
      defaultDate: (0,_utils_date_js__WEBPACK_IMPORTED_MODULE_0__.humanizeOrderData)(this._state.startDate, _const_js__WEBPACK_IMPORTED_MODULE_2__.FormatTime.YEAR_MONTH_DAY_TIME),
  ...
  #setEndDatePicker() {
    this.#datePicker = (0,flatpickr__WEBPACK_IMPORTED_MODULE_3__["default"])(this.element.querySelector('#event-end-time-1'), {
      ...
      defaultDate: (0,_utils_date_js__WEBPACK_IMPORTED_MODULE_0__.humanizeOrderData)(this._state.endDate, _const_js__WEBPACK_IMPORTED_MODULE_2__.FormatTime.YEAR_MONTH_DAY_TIME),
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ ErrorServerView)
/* harmony export */ });
/* harmony import */ var _framework_view_abstract_view__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../framework/view/abstract-view */ "./src/framework/view/abstract-view.js");
...
class ErrorServerView extends _framework_view_abstract_view__WEBPACK_IMPORTED_MODULE_0__["default"] {
  get template() {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ InfoContainerView)
/* harmony export */ });
...
class InfoContainerView extends _framework_view_abstract_view_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  get template() {
...
/***/ "./src/view/InfoPriceHeaderView.js":
/*!*****************************************!*\
  !*** ./src/view/InfoPriceHeaderView.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ InfoPriceView)
/* harmony export */ });
/* harmony import */ var _framework_view_abstract_view_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../framework/view/abstract-view.js */ "./src/framework/view/abstract-view.js");
...
class InfoPriceView extends _framework_view_abstract_view_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  #pointModel = null;
...
/***/ "./src/view/InfoTextHeaderView.js":
/*!****************************************!*\
  !*** ./src/view/InfoTextHeaderView.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ InfoTextView)
/* harmony export */ });
/* harmony import */ var _framework_view_abstract_view_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../framework/view/abstract-view.js */ "./src/framework/view/abstract-view.js");
...
function createData(pointModel) {
  ...
  const startDate = pointsLength !== 0 ? (0,_utils_date_js__WEBPACK_IMPORTED_MODULE_1__.humanizeOrderData)(pointModel.points[0].startDate, _const_js__WEBPACK_IMPORTED_MODULE_2__.FormatTime.TIME_FORMAT_MMM_DD) : '';
  const endDate = pointsLength !== 0 ? (0,_utils_date_js__WEBPACK_IMPORTED_MODULE_1__.humanizeOrderData)(pointModel.points[pointsLength - 1].endDate, _const_js__WEBPACK_IMPORTED_MODULE_2__.FormatTime.TIME_FORMAT_MMM_DD) : '';
  return `
    <p class="trip-info__dates">${startDate}&nbsp;&mdash;&nbsp;${endDate}</p>
  `;
}
class InfoTextView extends _framework_view_abstract_view_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  #pointModel = null;
  constructor(pointModel) {
    super();
    this.#pointModel = pointModel;
...
/***/ "./src/view/InfoTitleHeaderView.js":
/*!*****************************************!*\
  !*** ./src/view/InfoTitleHeaderView.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ InfoTitleView)
/* harmony export */ });
/* harmony import */ var _framework_view_abstract_view_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../framework/view/abstract-view.js */ "./src/framework/view/abstract-view.js");
...
class InfoTitleView extends _framework_view_abstract_view_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  #pointModel = null;
  constructor(pointModel) {
    super();
    this.#pointModel = pointModel;
...
/***/ "./src/view/InfoWrapperContentView.js":
/*!********************************************!*\
  !*** ./src/view/InfoWrapperContentView.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ InfoWrapperContentView)
/* harmony export */ });
/* harmony import */ var _framework_view_abstract_view_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../framework/view/abstract-view.js */ "./src/framework/view/abstract-view.js");
...
class InfoWrapperContentView extends _framework_view_abstract_view_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  get template() {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ TripListPointView)
/* harmony export */ });
/* harmony import */ var _framework_view_abstract_view_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../framework/view/abstract-view.js */ "./src/framework/view/abstract-view.js");
...
class TripListPointView extends _framework_view_abstract_view_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  get template() {
...
class LoadingView extends _framework_view_abstract_view__WEBPACK_IMPORTED_MODULE_0__["default"] {
  get template() {
...
function createTemplateOffer(offer, isDisabled) {
  return `
  <div class="event__offer-selector">
    <input class="event__offer-checkbox  visually-hidden" data-id="${he__WEBPACK_IMPORTED_MODULE_2___default().encode(offer.id)}" id="event-offer-luggage-${he__WEBPACK_IMPORTED_MODULE_2___default().encode(offer.id)}" type="checkbox" name="event-offer-luggage" ${isDisabled ? 'disabled' : ''}>
    <label class="event__offer-label" data-id="${he__WEBPACK_IMPORTED_MODULE_2___default().encode(offer.id)}" for="event-offer-luggage-${offer.id}">
...
function createPicturesDestinationsTemplate(picture) {
  return `<img class="event__photo" src="${picture.src}" alt="${he__WEBPACK_IMPORTED_MODULE_2___default().encode(picture.description)}">`;
}
function createTitleDestinationsTemplate(title, id) {
  return `<option value="${he__WEBPACK_IMPORTED_MODULE_2___default().encode(title)}" data-id="${he__WEBPACK_IMPORTED_MODULE_2___default().encode(id)}">${he__WEBPACK_IMPORTED_MODULE_2___default().encode(title)}</option>`;
}
function createListEvents({
  typePoint,
  destinationId,
        ...
        <section class="event__details">
          ...
          ${selectDestination !== undefined ? `
            <section class="event__section  event__section--destination">
              ${selectDestination.description.length !== 0 ? `
                <h3 class="event__section-title  event__section-title--destination">Destination</h3>
                <p class="event__destination-description">${he__WEBPACK_IMPORTED_MODULE_2___default().encode(selectDestination.description)}</p>
                <div class="event__photos-container">
                  <div class="event__photos-tape">
                    ${selectDestination.pictures.map(picture => createPicturesDestinationsTemplate(picture))}
                  </div>
...
function noPointTemplate({
  ...
  const noPointTextValue = _const__WEBPACK_IMPORTED_MODULE_1__.NoTasksTextType[filterType];
  return `
    <p class="trip-events__msg">${noPointTextValue}</p>
  `;
}
class NoPointView extends _framework_view_abstract_view__WEBPACK_IMPORTED_MODULE_0__["default"] {
  #filterType = null;
  constructor({
    filterType
  }) {
...
/* harmony import */ var _framework_view_abstract_view_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../framework/view/abstract-view.js */ "./src/framework/view/abstract-view.js");
...
function createOrderTemplate(point, offers, destination) {
  ...
  const formatStartTime = (0,_utils_date_js__WEBPACK_IMPORTED_MODULE_0__.humanizeOrderData)(startDate, _const_js__WEBPACK_IMPORTED_MODULE_1__.FormatTime.TIME_FORMAT_H_M);
  const formatEndTime = (0,_utils_date_js__WEBPACK_IMPORTED_MODULE_0__.humanizeOrderData)(endDate, _const_js__WEBPACK_IMPORTED_MODULE_1__.FormatTime.TIME_FORMAT_H_M);
  return `
    <li class="trip-events__item">
      <div class="event">
        <time class="event__date" datetime="${startDate !== null ? startDate : ''}">${(0,_utils_date_js__WEBPACK_IMPORTED_MODULE_0__.humanizeOrderData)(startDate)}</time>
        ...
        <div class="event__schedule">
          ...
          <p class="event__duration">${(0,_utils_date_js__WEBPACK_IMPORTED_MODULE_0__.dateSubtract)(endDate, startDate)}</p>
        </div>
...
/***/ "./src/view/TripFilterControlsView.js":
/*!********************************************!*\
  !*** ./src/view/TripFilterControlsView.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ TripControlsView)
/* harmony export */ });
/* harmony import */ var _framework_view_abstract_view_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../framework/view/abstract-view.js */ "./src/framework/view/abstract-view.js");
...
class TripControlsView extends _framework_view_abstract_view_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  #filters = null;
  #currentFilterType = null;
...
/***/ "./src/view/TripSortPointsView.js":
/*!****************************************!*\
  !*** ./src/view/TripSortPointsView.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ TripSortPointsView)
/* harmony export */ });
/* harmony import */ var _framework_view_abstract_view_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../framework/view/abstract-view.js */ "./src/framework/view/abstract-view.js");
/* harmony import */ var _const_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../const.js */ "./src/const.js");
...
function createTripSortContent(currentTypeSort) {
  ...
  <form class="trip-events__trip-sort  trip-sort" action="#" method="get">
    <div class="trip-sort__item  trip-sort__item--day">
      <input id="sort-day" class="trip-sort__input  visually-hidden" data-sort-type="${_const_js__WEBPACK_IMPORTED_MODULE_1__.SortType.DAY}" type="radio" name="trip-sort" value="sort-${_const_js__WEBPACK_IMPORTED_MODULE_1__.SortType.DAY}" ${currentTypeSort === _const_js__WEBPACK_IMPORTED_MODULE_1__.SortType.DAY ? 'checked' : ''}>
      <label class="trip-sort__btn" for="sort-day" data-sort-type="${_const_js__WEBPACK_IMPORTED_MODULE_1__.SortType.DAY}">Day</label>
    </div>
    ...
    <div class="trip-sort__item  trip-sort__item--time">
      <input id="sort-time" class="trip-sort__input  visually-hidden" data-sort-type="${_const_js__WEBPACK_IMPORTED_MODULE_1__.SortType.TIME}" type="radio" name="trip-sort" value="sort-${_const_js__WEBPACK_IMPORTED_MODULE_1__.SortType.TIME}" ${currentTypeSort === _const_js__WEBPACK_IMPORTED_MODULE_1__.SortType.TIME ? 'checked' : ''}>
      <label class="trip-sort__btn" for="sort-time" data-sort-type="${_const_js__WEBPACK_IMPORTED_MODULE_1__.SortType.TIME}">Time</label>
    </div>

    <div class="trip-sort__item  trip-sort__item--price">
      <input id="sort-price" class="trip-sort__input  visually-hidden" data-sort-type="${_const_js__WEBPACK_IMPORTED_MODULE_1__.SortType.PRICE}" type="radio" name="trip-sort" value="sort-${_const_js__WEBPACK_IMPORTED_MODULE_1__.SortType.PRICE}" ${currentTypeSort === _const_js__WEBPACK_IMPORTED_MODULE_1__.SortType.PRICE ? 'checked' : ''}>
      <label class="trip-sort__btn" for="sort-price" data-sort-type="${_const_js__WEBPACK_IMPORTED_MODULE_1__.SortType.PRICE}">Price</label>
    </div>
...
class TripSortPointsView extends _framework_view_abstract_view_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
...
/* harmony import */ var _model_filter_model_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./model/filter-model.js */ "./src/model/filter-model.js");
/* harmony import */ var _point_api_service_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./point-api-service.js */ "./src/point-api-service.js");
...
const pointModel = new _model_points_model_js__WEBPACK_IMPORTED_MODULE_1__["default"]({
  pointApiService: new _point_api_service_js__WEBPACK_IMPORTED_MODULE_3__["default"](END_POINT, AUTHORIZATION),
  contentContainer: tripContent
});
const filterModel = new _model_filter_model_js__WEBPACK_IMPORTED_MODULE_2__["default"]();
