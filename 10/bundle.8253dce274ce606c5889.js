...
/* harmony export */   TYPE_ROUTES: () => (/* binding */ TYPE_ROUTES),
/* harmony export */   YEAR_MONTH_DAY: () => (/* binding */ YEAR_MONTH_DAY)
/* harmony export */ });
const TYPE_ROUTES = ['taxi', 'bus', 'train', 'ship', 'sightseeing'];
...
//, 'Drive', 'Flight', 'Check-in', , 'Restaurant'
...
class contentPresenter {
  ...
  #handlerPointChange = updatePoint => {
    this.#dataPoints = (0,_utils_common_js__WEBPACK_IMPORTED_MODULE_7__.updateDataItem)(this.#dataPoints, updatePoint);
    this.#sourcedDataPoints = (0,_utils_common_js__WEBPACK_IMPORTED_MODULE_7__.updateDataItem)(this.#sourcedDataPoints, updatePoint);
  ...
  #sortPoint(sortType) {
    switch (sortType) {
      case `${_const_js__WEBPACK_IMPORTED_MODULE_5__.SORT_TYPE.TIME}`:
        this.#dataPoints.sort(_utils_point_js__WEBPACK_IMPORTED_MODULE_4__.sortPointByTime);
        break;
      case `${_const_js__WEBPACK_IMPORTED_MODULE_5__.SORT_TYPE.PRICE}`:
        this.#dataPoints.sort(_utils_point_js__WEBPACK_IMPORTED_MODULE_4__.sortPointByPrice);
        break;
      case `${_const_js__WEBPACK_IMPORTED_MODULE_5__.SORT_TYPE.DAY}`:
...
class InfoPresenter {
  ...
  init() {
    ...
    (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_7__.render)(new _view_button_add_point_js__WEBPACK_IMPORTED_MODULE_6__["default"](), this.#headerContainer);
  }
}
...
function listType() {
  ...
  <fieldset class="event__type-group">
    ...
    ${_const_js__WEBPACK_IMPORTED_MODULE_1__.TYPE_ROUTES.map(type => `
...
function editingPoint(point, checkedOffers, offers, destinations) {
  ...
  const startFormatDate = (0,_utils_date_js__WEBPACK_IMPORTED_MODULE_0__.humanizeOrderData)(startDate, _const_js__WEBPACK_IMPORTED_MODULE_1__.YEAR_MONTH_DAY);
  const endFormatDate = (0,_utils_date_js__WEBPACK_IMPORTED_MODULE_0__.humanizeOrderData)(endDate, _const_js__WEBPACK_IMPORTED_MODULE_1__.YEAR_MONTH_DAY);
  return `
...
class EventEditView extends _framework_view_abstract_view_js__WEBPACK_IMPORTED_MODULE_2__["default"] {
  #point = null;
  #checkedOffers = null;
  #destinations = null;
  #offers = null;
...
const headerPresenter = new _presenter_header_presenter_js__WEBPACK_IMPORTED_MODULE_1__["default"]({
...
/******/ })()
;
//# sourceMappingURL=bundle.8253dce274ce606c5889.js.map