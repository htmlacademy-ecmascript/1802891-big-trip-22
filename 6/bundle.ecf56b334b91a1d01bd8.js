...
class contentPresenter {
  ...
  init() {
    ...
    for (let i = 0; i < QUANTITY_EVENT; i++) {
      (0,_render_js__WEBPACK_IMPORTED_MODULE_5__.render)(new _view_point_js__WEBPACK_IMPORTED_MODULE_0__["default"]({
    ...
    (0,_render_js__WEBPACK_IMPORTED_MODULE_5__.render)(new _view_add_point_js__WEBPACK_IMPORTED_MODULE_3__["default"]({
    ...
    (0,_render_js__WEBPACK_IMPORTED_MODULE_5__.render)(new _view_edit_point_js__WEBPACK_IMPORTED_MODULE_4__["default"]({
      point: this.contentPoints[0],
      checkedOffers: [...this.pointModel.getOfferById(this.contentPoints[0].typePoints, this.contentPoints[0].offers)],
      offers: this.pointModel.getOfferByType(this.contentPoints[0].typePoints),
      destinations: this.pointModel.getDestinationsById(this.contentPoints[0].destinations)
...
function createListEvents(point, checkedOffers, offers, destinations) {
  ...
  const sData = (0,_utils_js__WEBPACK_IMPORTED_MODULE_1__.humanizeOrderData)(startData, _const_js__WEBPACK_IMPORTED_MODULE_2__.YEAR_MONTH_DAY);
  const eData = (0,_utils_js__WEBPACK_IMPORTED_MODULE_1__.humanizeOrderData)(endData, _const_js__WEBPACK_IMPORTED_MODULE_2__.YEAR_MONTH_DAY);
  return `
...
function createOrderTemplate(point, offers, destination) {
  ...
  const dataFormat = (0,_utils_js__WEBPACK_IMPORTED_MODULE_1__.humanizeOrderData)(startData, _const_js__WEBPACK_IMPORTED_MODULE_2__.MONTH_DATA_FORMAT);
  const sTime = (0,_utils_js__WEBPACK_IMPORTED_MODULE_1__.humanizeOrderData)(startData, _const_js__WEBPACK_IMPORTED_MODULE_2__.TIME_FORMAT);
  const eTime = (0,_utils_js__WEBPACK_IMPORTED_MODULE_1__.humanizeOrderData)(endData, _const_js__WEBPACK_IMPORTED_MODULE_2__.TIME_FORMAT);
...
/* harmony import */ var _model_points_model_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./model/points-model.js */ "./src/model/points-model.js");
...
const tripContent = document.querySelector('.trip-events');
const pointModel = new _model_points_model_js__WEBPACK_IMPORTED_MODULE_3__["default"]();
...
/******/ })()
;
//# sourceMappingURL=bundle.ecf56b334b91a1d01bd8.js.map